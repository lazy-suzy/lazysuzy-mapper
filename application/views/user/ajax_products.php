   ...
   if (!empty($products)) {
      ...
      foreach ($products as $product_details) {
         if ('' != $product_details->main_product_images) {
            if ("pier1" == $product_details->site_name) {
               $site       = 'Pier-1';
               $new_images = "/" . $site . "/" . $product_details->main_product_images;
            } else {
               $new_images = $product_details->main_product_images;
            }
         } else {
    ...
    <div id="product-modal<?php echo $product_details->id; ?>" class="product-modal" style="display:none;">
      ...
      <div class="row outter-container">
        <div class="col-md-7 product-img-modal">
          <div class="row">
            <div class="active-img col-md-12">
              <img src="<?php echo $new_images; ?>" class="lazyload" alt="">
            </div>
          </div>
              ...
              <div class="d-flex justify-content-around">
                <?php
                   if (strpos($product_details->product_images, ',') !== false) {
                            ...
                            ?>
                    <div class="sub-img">
                      <img src="../<?php echo $product_details->site_name; ?>/product_images/<?php echo $thumbs; ?>" class="lazyload" alt="">
                    </div>
                    <?php
                       }
                             } else {
                             ?>
                  <div class="sub-img">
                    <img src="../<?php echo $product_details->site_name; ?>/product_images/<?php echo $product_details->product_images; ?>" class="lazyload" alt="">
                  </div>
                  <?php
                     }
                        ?>
        ...
        <div class="col-md-5">
          ...
          <?php
             if ('' != $product_details->product_diemension || NULL != $product_details->product_diemension) {
                   ?>
            <div class="product-dimensions d-flex justify-content-center">
              <div class="dims">
                ...
                <?php
                   if ('CB2' == $product_details->site_name) {
